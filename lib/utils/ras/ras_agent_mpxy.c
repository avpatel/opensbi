...
#define MAX_RAS_RPMI_PROPS		(MPXY_MSGPROT_RPMI_ATTR_MAX_ID - \
					 SBI_MPXY_ATTR_MSGPROTO_ATTR_START)
#define RAS_AGENT_RPMI_SVCGRP_ID	0xC
#define RAS_AGENT_RPMI_SVCGRP_VER	SBI_MPXY_MSGPROTO_VERSION(1, 0)
/* FIXME: Need separate RPMI implementation ID for OpenSBI */
#define RAS_AGENT_RPMI_IMPL_ID		0x0
#define RAS_AGENT_RPMI_IMPL_VER		SBI_MPXY_MSGPROTO_VERSION(1, 0)

static u32 ras_rpmi_props[MAX_RAS_RPMI_PROPS] = { RAS_AGENT_RPMI_SVCGRP_ID,
						  RAS_AGENT_RPMI_SVCGRP_VER,
						  RAS_AGENT_RPMI_IMPL_ID,
						  RAS_AGENT_RPMI_IMPL_VER };
			      ...
			      u32 attr_count)
{
	...
	prop_index = base_attr_id - SBI_MPXY_ATTR_MSGPROTO_ATTR_START;
